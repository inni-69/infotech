...
void save_inni_contact()
{
	fp.open("contactBook.dat",ios::out|ios::app);
	cont.create_inni_contact();
...
void display_inni_contact(int num)
{
	bool found;
	int ch;
